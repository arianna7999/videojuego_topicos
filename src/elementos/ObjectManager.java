...
public class ObjectManager {
    ...
    private void cargarSprites() {
        ...
        for (int i = 0; i < llaveImgs.length; i++) {
            llaveImgs[i] = imgCompletaLlave.getSubimage(i * anchoUnFrameLlave, 0, anchoUnFrameLlave, imgCompletaLlave.getHeight());
        }
    ...
    public void update() {
        ...
        for (Recompensas r : recompensas) if (r.isActivo()) r.updateAnimation();
    ...
    public void draw(Graphics g, int xLvlOffset, int yLvlOffset) {
        ...
        for (Contenedor c : contenedores) {
            if (c.isActivo()) {
                ...
                g.drawImage(img, (int) (c.getX() - xLvlOffset), c.getY() - yLvlOffset + 12, (int) (40 * Juego.SCALE), (int) (30 * Juego.SCALE), null);
                
                if (c.getTipoObjeto() == BARRIL && c.getEstado() == 1) { 
                    g.drawImage(explosionImgs[c.getAnimInd()], (int) (c.getX() - xLvlOffset - 30), c.getY() - 35 - yLvlOffset, (int)(100*Juego.SCALE), (int)(100*Juego.SCALE), null);
                }
            }
        }
